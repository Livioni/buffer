...
def Ali_function_cost_usd(Time: np.float64, Mem: float, CPU: float, GPU: float,\
                 Pcpu : np.float64 = 0.00002138, Pmem: np.float64 = 0.00002138, Pgpu : np.float64 = 0.000105,\
                 basic_cost : np.float64 = 0.0000002) -> np.float64:
    '''
    This function calculates the cost of serverless function for Aliyun, note that this is per-trigger cost.
    Accroding to https://help.aliyun.com/document_detail/54301.html
    Args:
...
def Ali_idle_cost(Time: np.float64, Mem: float, GPU: float, Pmem : np.float64 = 0.0000127*0.2,Pgpu:np.float64 = 0.0007*0.2) -> np.float64:
    '''
