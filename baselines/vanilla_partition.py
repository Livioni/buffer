...
for i in range(1,duplication+1):
    ...
    record_file_name = 'AmpereA10_vanilla_partitions_' + scene_name + '_' + str(i)
    source_file_path = '/Users/livion/Documents/test_videos/' + scene_name + '/'
    save_csv_file_path = '/Users/livion/Documents/GitHub/Sources/buffer/data/vanilla-partitions/' + str(scene_name[0:8]) +'/'
    ## prepare data
...
excel_file_path = '/Users/livion/Documents/GitHub/Sources/buffer/data/vanilla-partitions/'+ scene_name[0:8] + '/' + scene_name[0:8] + '.xlsx'
