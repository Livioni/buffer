...
from buffer import Clipper,Image

scene_name = 'partitions_01'
network_bandwidth = 20 # 10Mbps6
...
batch_size = 5
SLO = 1.4
record_file_name1 = 'clipper_bandwidth='+ str(network_bandwidth) + '_SLO=' + str(SLO) + 's_1'
# record_file_name2 = 'clipper_SLO=' + str(SLO) + 's_2'
table1 = Clipper(record_file_name=record_file_name1,batch_size=batch_size, csv_record=True)
