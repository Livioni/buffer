...
batch_size = 8
SLO = 0.7
record_file_name1 = 'Mark_bandwidth='+ str(network_bandwidth) + '_SLO=' + str(SLO) + 's_1'
# record_file_name2 = 'clipper_SLO=' + str(SLO) + 's_2'
table1 = Mark(record_file_name=record_file_name1,batch_size=batch_size, csv_record=True)
